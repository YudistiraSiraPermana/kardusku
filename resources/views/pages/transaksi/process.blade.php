                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-success btn-block" data-toggle="modal"
                                    id='btn_tambah' data-target=".modal-tambah">
                                    <li class="fa fa-plus"></li>&nbsp; Tambah Stok
                                </button>
                                <form action="{{ route('transaksi.add.stock') }}" method="post"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" class="form-control
                                                            @error('id')
                                                                is-invalid
                                                            @enderror" value="{{ $id }}" name="add_stock_id"
                                                        id="add_stock_id" readonly hidden />
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-success btn-block" data-toggle="modal"
                                    id="btn_kurang" data-target=".modal-kurangi">
                                    <li class="fa fa-minus"></li>&nbsp; Kurangi Stok
                                </button>
                                <form action="{{ route('transaksi.add.subtract') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal fade modal-kurangi" tabindex="-1" role="dialog"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" class="form-control
                                                            @error('id')
                                                                is-invalid
                                                            @enderror" value="{{ $id }}" name="subtract_stock_id"
                                                        id="subtract_stock_id" readonly hidden />
                                                    <input type="number" class="form-control" name="jumlah"
                                                        id="jumlah" />
                                                    <select name="status" id="status" hidden>
