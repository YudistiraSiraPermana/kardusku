...
<!-- Animate.css -->
<link href="{{ asset('/template_admin/vendors/animate.css/animate.min.css') }}" rel="stylesheet">
...
<!-- Font Awesome -->
<link rel="stylesheet" href="{{ asset('/template_admin/vendors/fontawesome-free/css/all.min.css') }}">
<!-- icheck bootstrap -->
